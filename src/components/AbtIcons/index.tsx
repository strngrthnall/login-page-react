import AbtIconStyle from "./styles"

export type Props = {
  iconSize?: number
  iconType?: 'feed' | 'share' | 'find'
  color: 'main' | 'secondary' 
}

function AbtIcons({ iconSize = 16, iconType = 'feed', color }: Props) {
  
  if (iconType === 'feed') {
    return (
      <AbtIconStyle color={color}>
        <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} fill="currentColor" className="bi bi-newspaper" viewBox="0 0 16 16">
    ...
    return (
      <AbtIconStyle color={color}>
        <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} fill="currentColor" className="bi bi-share-fill" viewBox="0 0 16 16">
          <path d="M11 2.5a2.5 2.5 0 1 1 .603 1.628l-6.718 3.12a2.5 2.5 0 0 1 0 1.504l6.718 3.12a2.5 2.5 0 1 1-.488.876l-6.718-3.12a2.5 2.5 0 1 1 0-3.256l6.718-3.12A2.5 2.5 0 0 1 11 2.5" />
        </svg>
      </AbtIconStyle>
    )
  } else if (iconType === 'find') {
    return (
      <AbtIconStyle color={color}>
        <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} fill="currentColor" className="bi bi-share-fill" viewBox="0 0 16 16">
